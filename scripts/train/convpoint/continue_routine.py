...
if __name__ == "__main__":
    ...
    network_config = load_config(
        os.path.join(
            ...
            "config",
            "network_config",
            experiment_name + experiment_suffix + ".json",
        )
    )
    ...
    # drop_learning rate by a min factor of 16
    ...
    try:
        ...
        trainer.fit(
            ...
            train_loader,
            val_loader,
            ckpt_path=os.path.join(exp_path, "val_best.ckpt"),
        )
