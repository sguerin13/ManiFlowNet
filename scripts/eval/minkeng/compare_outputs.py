...
if __name__ == "__main__":
    ...
    vp_list = eval_utils.get_normalization_values(fpaths.valDataFPath)

    # coords, output feats, target_feats
    output_features, output_coords, target_features = eval_utils.get_ME_eval_output_for_single_sample(
        val_loader, net
    )
    ...
    df_pred, df_y = eval_utils.convert_ME_feats_and_coords_to_df(
        inv_out,
        output_coords,
        inv_target,
    ...
    # eval_utils.create_plot(df_pred_inv,df_y_inv,df_pred_inv,x_scale_tuple,y_scale_tuple, z_scale_tuple, pressure_scale_tuple, 1,5)
    # eval_utils.plot_output(df_pred_filt,v_scale_tuple,p_scale_tuple,scale_factor)
    # eval_utils.plot_output(df_y_filt,v_scale_tuple,p_scale_tuple,scale_factor)
    # print("HERE")
